...
export type Mutation_Root = {
  ...
  /** delete data from the table: "profile_user" */
  delete_profile_user?: Maybe<Profile_User_Mutation_Response>;
  /** delete single row from the table: "profile_user" */
  delete_profile_user_by_pk?: Maybe<Profile_User>;
  ...
  /** insert data into the table: "profile_user" */
  insert_profile_user?: Maybe<Profile_User_Mutation_Response>;
  /** insert a single row into the table: "profile_user" */
  insert_profile_user_one?: Maybe<Profile_User>;
  ...
  /** update data of the table: "profile_user" */
  update_profile_user?: Maybe<Profile_User_Mutation_Response>;
  /** update single row of the table: "profile_user" */
  update_profile_user_by_pk?: Maybe<Profile_User>;
...
/** mutation root */
export type Mutation_RootDelete_Profile_UserArgs = {
  where: Profile_User_Bool_Exp;
};


/** mutation root */
export type Mutation_RootDelete_Profile_User_By_PkArgs = {
...
/** mutation root */
export type Mutation_RootInsert_Profile_UserArgs = {
  objects: Array<Profile_User_Insert_Input>;
  on_conflict?: InputMaybe<Profile_User_On_Conflict>;
};


/** mutation root */
export type Mutation_RootInsert_Profile_User_OneArgs = {
  object: Profile_User_Insert_Input;
  on_conflict?: InputMaybe<Profile_User_On_Conflict>;
};
...
/** mutation root */
export type Mutation_RootUpdate_Profile_UserArgs = {
  _set?: InputMaybe<Profile_User_Set_Input>;
  where: Profile_User_Bool_Exp;
};


/** mutation root */
export type Mutation_RootUpdate_Profile_User_By_PkArgs = {
  _set?: InputMaybe<Profile_User_Set_Input>;
  pk_columns: Profile_User_Pk_Columns_Input;
};
...
/** columns and relationships of "profile_user" */
...
/** aggregated selection of "profile_user" */
export type Profile_User_Aggregate = {
  __typename?: 'profile_user_aggregate';
  aggregate?: Maybe<Profile_User_Aggregate_Fields>;
  nodes: Array<Profile_User>;
};

/** aggregate fields of "profile_user" */
export type Profile_User_Aggregate_Fields = {
  __typename?: 'profile_user_aggregate_fields';
  count: Scalars['Int'];
  max?: Maybe<Profile_User_Max_Fields>;
  min?: Maybe<Profile_User_Min_Fields>;
};


/** aggregate fields of "profile_user" */
export type Profile_User_Aggregate_FieldsCountArgs = {
  columns?: InputMaybe<Array<Profile_User_Select_Column>>;
  distinct?: InputMaybe<Scalars['Boolean']>;
};

/** order by aggregate values of table "profile_user" */
export type Profile_User_Aggregate_Order_By = {
  count?: InputMaybe<Order_By>;
  max?: InputMaybe<Profile_User_Max_Order_By>;
  min?: InputMaybe<Profile_User_Min_Order_By>;
};

/** input type for inserting array relation for remote table "profile_user" */
export type Profile_User_Arr_Rel_Insert_Input = {
  data: Array<Profile_User_Insert_Input>;
  /** on conflict condition */
  on_conflict?: InputMaybe<Profile_User_On_Conflict>;
};

/** Boolean expression to filter rows from the table "profile_user". All fields are combined with a logical 'AND'. */
export type Profile_User_Bool_Exp = {
  _and?: InputMaybe<Array<Profile_User_Bool_Exp>>;
  _not?: InputMaybe<Profile_User_Bool_Exp>;
  _or?: InputMaybe<Array<Profile_User_Bool_Exp>>;
...
/** unique or primary key constraints on table "profile_user" */
export enum Profile_User_Constraint {
  /** unique or primary key constraint */
  ProfileUserPkey = 'profile_user_pkey'
}

/** input type for inserting data into table "profile_user" */
export type Profile_User_Insert_Input = {
...
/** aggregate max on columns */
export type Profile_User_Max_Fields = {
  __typename?: 'profile_user_max_fields';
  profile_id?: Maybe<Scalars['uuid']>;
  user_id?: Maybe<Scalars['uuid']>;
};

/** order by max() on columns of table "profile_user" */
export type Profile_User_Max_Order_By = {
  profile_id?: InputMaybe<Order_By>;
  user_id?: InputMaybe<Order_By>;
};

/** aggregate min on columns */
export type Profile_User_Min_Fields = {
  __typename?: 'profile_user_min_fields';
  profile_id?: Maybe<Scalars['uuid']>;
  user_id?: Maybe<Scalars['uuid']>;
};

/** order by min() on columns of table "profile_user" */
export type Profile_User_Min_Order_By = {
  profile_id?: InputMaybe<Order_By>;
  user_id?: InputMaybe<Order_By>;
};

/** response of any mutation on the table "profile_user" */
export type Profile_User_Mutation_Response = {
  __typename?: 'profile_user_mutation_response';
  /** number of rows affected by the mutation */
  affected_rows: Scalars['Int'];
  /** data from the rows affected by the mutation */
  returning: Array<Profile_User>;
};

/** on conflict condition type for table "profile_user" */
export type Profile_User_On_Conflict = {
  constraint: Profile_User_Constraint;
  update_columns?: Array<Profile_User_Update_Column>;
  where?: InputMaybe<Profile_User_Bool_Exp>;
};

/** Ordering options when selecting data from "profile_user". */
export type Profile_User_Order_By = {
...
/** primary key columns input for table: profile_user */
export type Profile_User_Pk_Columns_Input = {
  profile_id: Scalars['uuid'];
  user_id: Scalars['uuid'];
};

/** select columns of table "profile_user" */
export enum Profile_User_Select_Column {
  /** column name */
...
/** input type for updating data in table "profile_user" */
export type Profile_User_Set_Input = {
  profile_id?: InputMaybe<Scalars['uuid']>;
  user_id?: InputMaybe<Scalars['uuid']>;
};

/** update columns of table "profile_user" */
export enum Profile_User_Update_Column {
  /** column name */
  ProfileId = 'profile_id',
  /** column name */
  UserId = 'user_id'
...
export type Profiles = {
  ...
  profile_users: Array<Profile_User>;
  /** An aggregate relationship */
  profile_users_aggregate: Profile_User_Aggregate;
  /** An object relationship */
  user?: Maybe<Users>;
};
...
export type ProfilesProfile_UsersArgs = {
  distinct_on?: InputMaybe<Array<Profile_User_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Profile_User_Order_By>>;
  where?: InputMaybe<Profile_User_Bool_Exp>;
};
...
export type Profiles_Bool_Exp = {
  ...
  profile_users?: InputMaybe<Profile_User_Bool_Exp>;
  user?: InputMaybe<Users_Bool_Exp>;
};
...
export type Profiles_Insert_Input = {
  ...
  profile_users?: InputMaybe<Profile_User_Arr_Rel_Insert_Input>;
  user?: InputMaybe<Users_Obj_Rel_Insert_Input>;
};
...
export type Profiles_Order_By = {
  ...
  profile_users_aggregate?: InputMaybe<Profile_User_Aggregate_Order_By>;
  user?: InputMaybe<Users_Order_By>;
};
...
export type Query_Root = {
  ...
  /** fetch data from the table: "profile_user" */
  profile_user: Array<Profile_User>;
  /** fetch aggregated fields from the table: "profile_user" */
  profile_user_aggregate: Profile_User_Aggregate;
  /** fetch data from the table: "profile_user" using primary key columns */
  profile_user_by_pk?: Maybe<Profile_User>;
...
export type Query_RootProfile_UserArgs = {
  distinct_on?: InputMaybe<Array<Profile_User_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Profile_User_Order_By>>;
...
export type Query_RootProfile_User_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Profile_User_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Profile_User_Order_By>>;
...
export type Query_RootProfile_User_By_PkArgs = {
  profile_id: Scalars['uuid'];
  user_id: Scalars['uuid'];
};
...
export type Subscription_RootProfile_UserArgs = {
  distinct_on?: InputMaybe<Array<Profile_User_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Profile_User_Order_By>>;
...
export type Subscription_RootProfile_User_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Profile_User_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Profile_User_Order_By>>;
...
export type Subscription_RootProfile_User_By_PkArgs = {
  profile_id: Scalars['uuid'];
  user_id: Scalars['uuid'];
};
